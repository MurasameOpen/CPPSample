...
int main(int argc, const char *argv[])
{
    ...
    const char *CONS_KEY = "mT9P9pPyPpFf4mhH5XgIRQ";
    const char *CONS_SEC = "QSXiDAEf9LvrnyU45hoTIL5oNkYOpvEGoXezupRccE";
    const char *ATOK_KEY = "73251807-d1KM0iBWsyEZ0YlkkBC9dl4M3rTWKmb7Ed3b4CBOh";
    const char *ATOK_SEC = "9N0w68u8i6i7wFOaj93pKZHJkMBy1gdLwHNxypz27R4qs";
